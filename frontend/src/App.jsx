  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="login" element={user ? <Navigate to={user.role === "recruiter" ? "/recruiter" : "/jobs"} replace /> : <Login />} />
        <Route path="register" element={user ? <Navigate to={user.role === "recruiter" ? "/recruiter" : "/jobs"} replace /> : <Register />} />
